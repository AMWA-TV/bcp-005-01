...
If the Sink acts as a Gateway Device, it's supposed to expose its own EDID and therefore Receiver Capabilities and not take into account EDIDs of Sinks connected to the Gateway in a non-networked way.
