...
A software for setting up an IPMX-compatible device and synchronizing its state with NMOS APIs. It has an HTTP RESTful API called IPMX Device Control API which provides information about and control of an IPMX-driven device.
