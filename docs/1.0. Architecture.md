...
| ![Container Diagram for IPMX PRO AV System](images/svg/ipmx_container_diagram.svg) |
|:--:|
...
| ![Sequence Diagram for Pro AV User Retrieving Raw and Parsed EDID Information](images/svg/edid_retrieving_sequence.svg) |
|:--:|
