...
Set of multiple Media Essentials which are all acceptable for all Receivers implied to be a part of a further connection. Note that this set may merge into Essential Media set in further work.
