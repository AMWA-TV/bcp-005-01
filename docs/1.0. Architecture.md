...
Media description which describes a format acceptable for all Receivers implied to be a part of a further connection. A Media Profile consist of separate parameters required to set up Sender and such IS-04 resources behind it as Source and Flow.
