...
[EDID-CM-ARCH]  "EDID Connection Management Architecure", December 2020, <https://specs.amwa.tv/nmos-edid-connection-management/branches/v1.0-dev/docs/1.0._Architecture.html>.
